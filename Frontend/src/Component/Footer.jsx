...
function Footer() {
    ...
    return (
        <div className={`${toggle ? 'w-full absolute top-[92vh]' : 'w-full sm:w-[60%] z-30 lg:w-[50%] bg-white xl:w-[45%] 2xl:w-[40%] fixed bottom-0' } mx-auto flex h-auto gap-2 border-2 border-black justify-evenly py-2`}>
