                ...
                >
                    {
                        followersList.map((follower, index) => (
                            <NavLink to={follower._id} key={index} className='w-full h-auto flex p-2 my-2 gap-3 cursor-pointer rounded-lg active:bg-gray-200 md:hover:bg-gray-200'>
                ...
                >
                    {
                        followingList.map((following, index) => (
                            <NavLink to={following._id} key={index} className='w-full h-auto flex p-2 my-2 gap-3 cursor-pointer rounded-lg active:bg-gray-200 md:hover:bg-gray-200'>
